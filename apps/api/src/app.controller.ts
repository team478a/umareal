...
import { decrypt, hashToken, verifyPassword } from './security';
...
export class AppController {
  ...
  @Get('health') async health() { await this.auth.db.$queryRaw`SELECT 1`; return { status: 'ok', phase: '7b-billing-support' }; }
