...
export function MemberNotifications() {
  ...
  return <><div className="page-heading"><span className="eyebrow">NOTIFICATIONS</span><h1>お知らせ</h1><p>対象レース、WIN5紙面、無料速報、最終予想の公開履歴を確認できます。</p></div>
