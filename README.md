...
- 配信予約・アラート: `/admin/publication-schedules`。対象レース告知と無料パドック速報は、対象人数、チャネル、本文、予定時刻を確認してから予約できます。期限接近、実行遅延、下書き変更による失敗、通知配送失敗も確認できます。
