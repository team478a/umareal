...
| /account | 利用準備チェックリスト、会員情報、友達紹介URL・LINE共有・成立人数・マイルストーン・未使用/使用済み一日券と対象日選択、予備メール、LINE連携・受信状態・解除、通知設定、同意履歴、契約・支払履歴、請求問い合わせ。ADMIN/OPERATORは管理画面、EXPERTは担当管理画面への導線を表示 | 本人 |
...
| /admin/billing | 契約期間・猶予、1日利用、支払履歴、請求問い合わせ対応、外部決済申込、Stripe Webhook受信、期限切れ公開待ち一日券の確認・返金、test時のみローカル失敗/回復試験 | ADMIN+AAL2 |
